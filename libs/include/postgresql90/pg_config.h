...
#define PG_VERSION_STR "PostgreSQL 9.0.23 on x86_64-apple-darwin13.4.0, compiled by GCC Apple LLVM version 6.0 (clang-600.0.57) (based on LLVM 3.5svn), 64-bit"
